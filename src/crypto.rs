...
impl SessionKey {
    ...
    /// Encrypts any data.
    pub fn seal<A: AsRef<[u8]>, T: Serialize>(&mut self, aad: A, data: T) -> Result<Sealed<T>> {
    ...
    pub fn unseal<A: AsRef<[u8]>, T: DeserializeOwned>(
        ...
        let (ciphertext, nonce_bytes) = ciphertext.split_at_mut(ciphertext_len - aead::NONCE_LEN);
